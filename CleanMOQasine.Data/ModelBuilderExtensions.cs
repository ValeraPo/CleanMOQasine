    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Room>().HasData(
                new Room() { Name = "Жилая комната", Price = 1100, IsDeleted = false },
                new Room() { Name = "Гостиная", Price = 1300, IsDeleted = false },
                new Room() { Name = "Кухня", Price = 1300, IsDeleted = false },
                new Room() { Name = "Санузел", Price = 800, IsDeleted = false },
                new Room() { Name = "Гараж", Price = 1700, IsDeleted = false });
            ...
            modelBuilder.Entity<CleaningAddition>().HasData(
                new CleaningAddition() { Name = "Помыть пол", Price = 500, Duration = new TimeSpan(0, 30, 0), IsDeleted = false },
                ...
                new CleaningAddition() { Name = "Интим на час", Price = 3000, Duration = new TimeSpan(1, 0, 0), IsDeleted = false });
